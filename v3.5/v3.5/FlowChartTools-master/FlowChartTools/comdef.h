...
enum class LINE_HEAD_TYPE{ARROW0 = 0,ARROW1,ARROW2,ARROW3};
    // 图形类型             无   矩形  菱形      圆角矩形  椭圆形  线性     梯形      圆形   平行四边形      子流程     文档      胶囊
enum class PaintChartType{NONE,RECT,DIAMOND,ROUNDRECT,ELLIPSE,LINE,TRAPEZOID,CIRCLE,PARALLELOGRAM,SUBROUTINE,DOCUMENT,CAPSULE,TEXT};
