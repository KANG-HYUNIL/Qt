...
//added codes
void Chart_Line::copyLineData(Chart_Base *other)
{

    Chart_Line* otherLine = dynamic_cast<Chart_Line*>(other);
    if (otherLine)
    {
        this->startPos = otherLine->startPos;
        this->endPos = otherLine->endPos;
        this->startDirect = otherLine->startDirect;
        this->endDirect = otherLine->endDirect;
        this->startMagIndex = otherLine->startMagIndex;
        this->endMagIndex = otherLine->endMagIndex;
        // this->startChartMag = otherLine->startChartMag;
        // this->endChartMag = otherLine->endChartMag;
        this->startLineHeadType = otherLine->startLineHeadType;
        this->endLineHeadType = otherLine->endLineHeadType;
    }
...
void Chart_Line::paintChart(QPainter & p)
{
    ...
    chartText.textType2->setGeometry((width()>>1) - (chartText.textType2->width()>>1),(height()>>1) - (chartText.textType2->height()>>1),chartText.textType2->width(),chartText.textType2->height());
            ...
            switch(endDirect)
            {
                case ORIENTION::NORTH:{
                    ...
                    if(sy>ey)
                    {
                        ...
                        chartText.textType2->setGeometry((width()>>1) - (chartText.textType2->width()>>1),ey - (chartText.textType2->height()>>1),chartText.textType2->width(),chartText.textType2->height());
                        ...
                        graphPath->addRect(sx,sy + containsWidth1_2,ex - sx,-containsWidth);
                        graphPath->addRect(ex - containsWidth1_2,sy,containsWidth,ey - sy);
                        chartText.textType2->setGeometry((width()>>1) - (chartText.textType2->width()>>1),sy - (chartText.textType2->height()>>1),chartText.textType2->width(),chartText.textType2->height());
                ...
                case ORIENTION::EAST:{
                    ...
                    if(sy>ey)
                    {
                        if(sx>ex)
                        {
                            ...
                            chartText.textType2->setGeometry((width()>>1) - (chartText.textType2->width()>>1),midy - (chartText.textType2->height()>>1),chartText.textType2->width(),chartText.textType2->height());
                        ...
                        if(sx>ex)
                        {
                            ...
                            chartText.textType2->setGeometry(midx - (chartText.textType2->width()>>1),(height()>>1)  - (chartText.textType2->height()>>1),chartText.textType2->width(),chartText.textType2->height());
            ...
            switch(endDirect)
            {
                ...
                case ORIENTION::EAST:{
                    ...
                    if(sx>ex)
                    {
                        ...
                        chartText.textType2->setGeometry(sx - (chartText.textType2->width()>>1),(height()>>1) - (chartText.textType2->height()>>1),chartText.textType2->width(),chartText.textType2->height());
                        ...
                        chartText.textType2->setGeometry(ex - (chartText.textType2->width()>>1),(height()>>1) - (chartText.textType2->height()>>1),chartText.textType2->width(),chartText.textType2->height());
